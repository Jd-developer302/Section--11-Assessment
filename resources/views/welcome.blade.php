...
<body>
    <div class="container">
        <a class="text-center">Assessment</a>
        ...
        <div class="section">
            ...
            <h3><span class="function-name">sortByAgeDescending()</span> - Sorts the array by age in descending order
            </h3>
        ...
        <div class="section">
            ...
            <h3><span class="function-name">convertToArrayOfArrays()</span> - Converts array using 'age' as array key
            </h3>
